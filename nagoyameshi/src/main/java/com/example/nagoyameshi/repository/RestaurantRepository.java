...
public interface RestaurantRepository extends JpaRepository<Restaurant, Integer> {
    ...
    public Page<Restaurant> findByNameLikeOrAddressLikeOrderByLowestPriceDesc(String nameKeyword, String addressKeyword, Pageable pageable);
    ...
    public Page<Restaurant> findByLowestPriceLessThanEqualOrderByLowestPriceDesc(Integer lowestPrice, Pageable pageable);
    ...
    public Page<Restaurant> findByCategoryLikeOrderByLowestPriceDesc(String category, Pageable pageable);
    public Page<Restaurant> findAllByOrderByCreatedAtDesc(Pageable pageable);
    public Page<Restaurant> findAllByOrderByLowestPriceAsc(Pageable pageable);
    public Page<Restaurant> findAllByOrderByLowestPriceDesc(Pageable pageable);
